...
function DashboardPage() {
  ...
  if (!context || Object.keys(context).length === 0) {
    console.log(
      "DashboardPage: Context kosong atau belum tersedia, menampilkan loading."
    );
    return (
  ...
  const financialNote =
    financialStatus && financialStatus.level !== undefined // Tambahkan null/undefined check untuk level
